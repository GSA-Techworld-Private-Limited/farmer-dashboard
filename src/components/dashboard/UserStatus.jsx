...
const UserStatus = () => {
  const { stats, productListStats, setTitle } = useContext(MyContext);
      ...
      <div className="flex justify-between">
        ...
        <div className="w-[312px] px-[22px] pt-3 bg-[#F9F9F9] border border-[#c6c6c6] rounded-xl">
          <div className="flex items-center justify-between">
            ...
            <button
              onClick={() => {
                navigate("/products"), setTitle("Products");
              }}
              className="text-[10px] underline text-[#303972] font-poppins font-semibold"
            >
              View All
            </button>
          </div>
          ...
          <div className="flex flex-col pb-5 max-h-[270px] overflow-auto gap-2 mt-2">
            {productListStats &&
